...
var _this = this;
var fetBtn = document.getElementById('fetchUserData');
fetBtn === null || fetBtn === void 0 ? void 0 : fetBtn.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
    var userDataDiv, userIdElement, userId, apiUrl, res, user, error_1, errorMsg;
