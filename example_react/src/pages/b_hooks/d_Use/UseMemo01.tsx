...
// : 성능 최적화를 위한 Hook
// >> 컴포넌트가 렌더링 될 때 특정 연산의 결과를 메모리에 저장하여 동일한값에 대해서는 해당 연산을 다시 수행하지 않도록 하는 훅
...
export default function UseMemo01() {
  ...
  return (
    <div>
      ...
      <p>
        <input type="text" value={inputValue} placeholder='입력해주세요' onChange={(e) => setInputValue(e.target.value)} />
      </p>
