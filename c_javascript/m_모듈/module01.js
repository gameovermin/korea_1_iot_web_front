...
//     - 스코프 격리 : 모듈 내에서 선언된 변수, 함수, 클래스 등은 모듈 외부에서 접근 X
//     - 이로인해 전역 변수의 사용 줄이고 이름 충돌을 방지
//     - 재사용성과 유지보수성 향상
...
// import { multifiy } from './module02.js';
...
function multifiy (x, y) {
  return x + y;
}

console.log(multifiy(2,3));
...
console.log(module02.multiply(5, 8));
