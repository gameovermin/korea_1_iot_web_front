...
function Person(name) {
  // this는 Person 생성자 함수로 생성되는 각가그이 객체를 의미
  // this.name은 각 객체의 속성
...
const person1 = new Person('라포르트');
const person2 = new Person('존스톤스');
...
const arrowObject1 = {
  name : 'object',
  showThis : function() {  // 화살표 함수 사용
    console.log(this);
  }

}

arrowObject1.showThis();  //  { name: 'object', showThis: [Function: showThis] }
...
arrowObject2.showThis();  // # {} : 전역 컨텍스트의 this와 동일 - 전역 객체

// ! 객체 내부의 this

// 객체 내부에서 현재 쓰이는 객체를 가져오기 위햇
