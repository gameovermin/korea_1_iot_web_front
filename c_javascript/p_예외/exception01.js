...
//     - ex) 파일을 찾을수 없거나 입력이 잘못 이루어진 경우, 네트워크 연결 오류 등
...
// cf) 자바스크립트는 SyntaxError라고 출력되는 오류 이외의 모든 로유가 예외(런타인 오류)로 분류
...
// catch 블록
// : 예외가 발생했을 때 실행되는 블록
// >> catch 블록 내에 전달되는 예외 객체를 통해 오류정보를 식별하고 처리
