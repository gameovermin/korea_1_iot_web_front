...
let result = sum(1, 2);
console.log(result);
console.log(sum(123123,23132)); // 146255
...
// greet2();  선언이 되어있지 않으므로 오류를 뱉어냄 (Error 호이스팅 X)
...
// ? 인자값(아규먼트, argument);
// : 실제 계싼을 위해(함수 사용을 위해) 파라미터로 전달되는 값
// - 파라미터가 변수의 선언
// - 인자값은 변수의 할당
// : 파라미터와 인자는 생략 가능
